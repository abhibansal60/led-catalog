...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-xl text-base font-semibold leading-snug transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-60 active:translate-y-[1px] ring-offset-background",
  {
    variants: {
      variant: {
        primary: "bg-primary text-primary-foreground hover:bg-primary/85 focus-visible:ring-primary",
        secondary:
      ...
      size: {
        default: "min-h-[3.25rem] px-6",
        sm: "h-10 px-4 text-sm",
        icon: "h-12 w-12 whitespace-nowrap",
      },
    },
    defaultVariants: {
      variant: "primary",
